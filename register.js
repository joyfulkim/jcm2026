...
const SESSIONS = [
  { id: 's1', label: '첫째날 저녁 집회', sub: '10월 9일 (금) · 오후 7시 30분', icon: '🌙' },
  { id: 's2', label: '둘째날 오전 집회', sub: '10월 10일 (토) · 오전 10시 30분', icon: '☀️' },
  { id: 's3', label: '둘째날 오후 집회', sub: '10월 10일 (토) · 오후 2시',       icon: '🌤️' },
];
